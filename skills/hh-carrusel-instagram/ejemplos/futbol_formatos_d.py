"""EJEMPLO v4 (aprobado): formatos D1–D5. OJO: este ejemplo MEZCLA formatos a propósito
(era una prueba). En carruseles reales usa una familia dominante (ver "Orden").
